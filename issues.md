...
- MCP tool names are displayed as raw identifiers (e.g. `mcp__plugin_llms-fetch-mcp_llms-fetch__fetch`) — should be shortened to a readable form like `llms-fetch: fetch`
