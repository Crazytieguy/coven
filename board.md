...
If several coven workers are woken up from sleep by commits on main, as soon as one of them decides to sleep, the others should go back to sleep as well. So for instance if there are 4 workers (a b c d), this might be a valid sequence:
